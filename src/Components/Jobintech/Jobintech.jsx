  ...
  return (
    ...
    <div className='max-w-[1200px] mx-auto min-h-screen flex items-center gap-5'>
      ...
      <div className="right-box flex-1 flex flex-col gap-7">
          ...
          <p className='font-[400] text-slate-500'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius assumenda laborum quas quia, nemo, labore quis doloribus corporis, deleniti delectus totam accusantium sunt molestiae dolore autem fuga vitae debitis explicabo.</p>
          <div className="flex gap-5">
           <a href='https://jobintech.academy/candidature-jobintech/' style={{background:`${yellow}`}} className='w-[160px] h-[50px] flex items-center justify-center font-[600] uppercase text-white'>register now</a>
           <a href='https://deft-begonia-126e62.netlify.app/' style={{background:`${blue}`}} className='w-[160px] h-[50px] flex gap-2 items-center justify-center font-[600] uppercase text-white'><FaCode/> Developpers</a>
          </div>
      </div>
    </div>
    </JobintechContainer>
